...
// =================================================
// 최소 숙박 일수 업데이트 //
async function host_min_reservation_date_controller(req, res, next){
    ...
    const result = await host_information_service_layer.update_min_reservation_date(user, host)
    res.status(200).json(result)
}

module.exports = {
    host_min_reservation_date_controller : async_handler(host_min_reservation_date_controller)
}